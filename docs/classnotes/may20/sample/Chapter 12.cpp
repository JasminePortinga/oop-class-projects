...
#include <iomanip>
#include <vector>
#include "Ch12_Employee.h"
#include "Ch12_Employee.cpp"
#include "Ch12_SalariedEmployee.h" 
#include "Ch12_SalariedEmployee.cpp" 
#include "Ch12_CommissionEmployee.h"  
#include "Ch12_CommissionEmployee.cpp"
#include "Ch12_BasePlusCommissionEmployee.h" 
#include "Ch12_BasePlusCommissionEmployee.cpp" 
using namespace std;
...
int main() {
	...
	const Employee* employeePtr;
	employeePtr = &commissionEmployee;
	cout << employeePtr->earnings() << endl;

	employeePtr = &salariedEmployee;
	cout << "\n" << employeePtr->earnings() << endl;

	employeePtr = &basePlusCommissionEmployee;
	cout << "\n" << employeePtr->earnings() << endl;
